...
# URLS
# ------------------------------------------------------------------------------
ROOT_URLCONF = "prof_education.urls"
WSGI_APPLICATION = "prof_education.wsgi.application"
...
if SENTRY_SDK is not None:
    sentry_sdk.init(
        dsn=SENTRY_SDK, integrations=[DjangoIntegration(), CeleryIntegration()]
    )
